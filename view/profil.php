  ...
  <div class="main">
    <div class="content">
      <div class="page-actions">
        <a class="btn btn-outline" href="/SportFuel-Module1/controller/AuthController.php?action=logout" style="text-decoration:none; color:#dc2626; border-color:#fee2e2; background:#fef2f2; margin-right: 15px;">🚪 Déconnexion</a>
